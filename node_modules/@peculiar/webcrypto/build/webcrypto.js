...
class RsaSsaProvider extends core.RsaSsaProvider {
    ...
    checkCryptoKey(key, keyUsage) {
        ...
        if (!(internalKey instanceof RsaPrivateKey$1 || internalKey instanceof RsaPublicKey$1)) {
...
class EcdsaProvider extends core.EcdsaProvider {
    ...
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        const internalKey = getCryptoKey(key);
        if (!(internalKey instanceof EcPrivateKey$1 || internalKey instanceof EcPublicKey$1)) {
